...
namespace WorkingHoursCounterSystemCore.Middlewere
{
    ...
    public class AuthMiddlewareAttribute : Attribute, IFilterFactory
    {
        ...
        public IFilterMetadata CreateInstance(IServiceProvider serviceProvider)
        {
            ...
            var repository = serviceProvider.GetRequiredService<GoogleAuthLogic>();
            return new AuthMiddlewareFilter(httpContextAccessor, repository);
        }

        private class AuthMiddlewareFilter(IHttpContextAccessor httpContextAccessor, GoogleAuthLogic authLogic) : IActionFilter
        {
